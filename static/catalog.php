      ...
      <div class="page__inner">
        <main class="page__content">
          <section class="catalog-hero hero-sections">
            <div class="hero-container">
              ...
              <div class="page-about">
                <div class="page-about__text">Огромный и разнообразный выбор товаров удовлетворит любого покупателя. В зависимости от материала, страны происхождения и многообразия форм и размеров, мы предоставляем возможность подобрать оптимальный вариант для любого клиента. Представляем Вашему вниманию наиболее востребованные формы стелл из гранита и мрамора, наличие на складе которых постоянно поддерживается. Также мы можем изготовить любую форму по Вашим фотографиям, чертежам и эскизам.</div>
          ...
          <section class="promotions">
            <div class="container">
              <h1 class="tech-works">Данный раздел временно недоступен. Извините за неудобства. Вы всегда можете воспользоваться функцией заказа звонка и уточнить необходимую информацию по телефону.</h1>
            </div>
          </section>
        </main>
      </div>
