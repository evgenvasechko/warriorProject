        ...
        <main class="page__content">
          <section class="main-hero">
            <div class="main-hero-desc"> 
              <h1>Heartstone.by</h1>Изделия из натурального камня, вазы надгробные, лампады и др.
            </div>
            ...
            <div class="container">
              ...
              <div class="main-advantages__list">
                ...
                <div class="main-advantages__unit main-advantages-unit">
                  ...
                  <h1 class="main-advantages-unit__header">Экономично</h1>
          ...
          <section class="promotions">
            <div class="container">
              <h1 class="reviews__header">Отзывы наших клиентов</h1>
              <div class="reviews__section">
                <div class="reviews__block">
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Константин</div>
                    </div>
                    <div class="review__text">Доброго времени суток. Заказывал в этой фирме памятник родственнику, с установкой. Простенький памятник из гранита с обкладкой прилежащей площадки плиткой. Сделали все качественно и довольно быстро - модель была в наличии. Фотографию изобразили один в один с оригиналом. Спасибо за качественную и быструю работу.</div>
                  </div>
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Александра</div>
                    </div>
                    <div class="review__text">Хочу сказать огромное спасибо Вам за профессионализм и деликатность в решении спорных вопросов и советы. Благодаря вам сумели избежать множества косяков по установке. Клиентоориентированность и деловой подход на высоте. На мой взгляд, эти ребята - тот редкий случай, когда получаешь оптимальный компромисс между ценой, качеством и скоростью. Спасибо еще раз!</div>
                  </div>
                </div>
                <div class="reviews__block">
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Мария</div>
                    </div>
                    <div class="review__text">Заказывали у ребят комплекс на две могилы с установкой, аксессуарами и фурнитурой. Вышло недешево, но за эти деньги мы получили просто шикарный памятник - материал, цвет, в целом внешний вид нас более чем устроил. По установке вопросов тоже пока не возникло, поживем - увидим. Спасибо.</div>
                  </div>
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Руслан</div>
                    </div>
                    <div class="review__text">Все были вежливы, подсказали что и как лучше сделать, удалось найти компромисс по цене. По моим средствам вышло скромно, но со вкусом. За скоростью не гнался, но по моему мнению сроки слишком затянуты не были. По качеству пока претензий тоже нет.</div>
                  </div>
                </div>
                <div class="reviews__block">
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Михаил</div>
                    </div>
                    <div class="review__text">Очень хотел найти плитку из гранита в частный дом, гуглил, искал у множества фирм, нашел эту компанию почти случайно - думал, что кроме памятников такие фирмы ничего не делают. Теперь нарадоваться не могу - в доме лежит плитка из китайского гранита, выглядит как я и ожидал. Удовольствие недешевое, конечно, но стоит того.</div>
                  </div>
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Антон</div>
                    </div>
                    <div class="review__text">Хотел родитеям поставить красивый памятник, пришел в эту фирму со своим рисунком, обсудили с Евгением все тонкости изготовления, создали модель и вместе составили техзадание для мастеров. Результатом остался очень доволен, форма получилась как раз то, что я хотел. Огромное спасибо за помощь, терпение и вашу работу, все получилось отлично. </div>
                  </div>
                </div>
                <div class="reviews__block">
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Татьяна</div>
                    </div>
                    <div class="review__text">Спасибо большое ребятам за гибкость и терпение! Заказывали с мужем столешницу и подоконники из камня, сделали быстро и красиво, установить пришлось самостоятельно - да и несложно было.</div>
                  </div>
                  <div class="review__unit">
                    <div class="review__author">
                      <div class="review__author_ico"><i class="fas fa-user-circle"></i></div>
                      <div class="review__author_name">Эдуард</div>
                    </div>
                    <div class="review__text">Видна компетентность сотрудников, в товаре ориентируются хорошо, по ценам тоже быстро могут соориентировать, а вариаций форм и аксессуаров очень много. Была небольшая заминка с установкой, как сказали - из-за очереди, но этот вопрос решился хоть и небольшой, но приятной скидочкой. Мелочь, а приятно. В конце концов работа была сделана хорошо от приема заказа до установки памятника.</div>
                  </div>
                </div>
              </div>
            </div>
